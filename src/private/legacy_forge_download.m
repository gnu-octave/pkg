...
## -*- texinfo -*-
## @deftypefn {} {[@var{list_file}, @var{list_file}] =} legacy_forge_download (@var{name})
## Resolve a package from legacy Octave Forge.
##
## The actual download is not performed, just a local tempname is suggested.
##
## Example: Resolve "io" package.
##
## @example
## @group
## [url, local_file] = legacy_forge_download ("io")
## url = https://packages.octave.org/download/io-2.6.3.tar.gz
## local_file = /tmp/io-2.6.3-7RJX1V.tar.gz
## @end group
## @end example
## @end deftypefn

function [url, local_file] = legacy_forge_download (name)
